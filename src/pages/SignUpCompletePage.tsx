      ...
      <form onSubmit={handleSubmit} className="mt-6 flex flex-col">
        <div className="border-y border-gray-200 py-1">
          <div className="flex min-h-12 items-center gap-3 px-2">
            ...
            >
              <span className="mr-1 text-blue-500">[필수]</span>
              서비스 이용약관 동의
            </label>
            <button
              type="button"
              onClick={() => setOpenAgreement("terms")}
              className="flex shrink-0 cursor-pointer items-center gap-0.5 p-2 text-xs font-medium text-gray-400 transition-colors hover:text-gray-700"
            >
              보기
