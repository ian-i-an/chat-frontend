...
export default function ChatReplyPreview({
  ...
  return (
    <div
      className={`relative z-0 -mb-1.5 max-w-full rounded-xl border border-gray-100 bg-gray-50 px-3 py-2 text-left text-xs leading-snug text-gray-500 shadow-sm ${
