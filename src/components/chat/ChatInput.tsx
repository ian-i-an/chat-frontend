    ...
    <div className="shrink-0 border-t border-gray-100 bg-white px-4 pt-3 pb-6">
      <div className="flex min-h-11 items-center gap-2 rounded-2xl bg-gray-100 pr-2 pl-4 transition-all focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-200">
        <textarea
          ...
          placeholder="메시지 보내기"
          className="my-1.5 max-h-21 flex-1 resize-none overflow-y-auto bg-transparent text-sm leading-relaxed font-medium text-gray-800 placeholder-gray-400 focus:outline-none"
        />
        <button
          onClick={handleSend}
